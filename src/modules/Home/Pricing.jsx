            ...
            <div className="bg-gradient-to-r from-[#053276] to-red-800 px-4">
                <div className="section Resizer mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <button className="px-8 py-3 border border-white text-white rounded-md text-base cursor-pointer hover:bg-white hover:text-[#053276] transition-all duration-300 flex items-center justify-center gap-2">
                            <Phone className="w-5 h-5" />
